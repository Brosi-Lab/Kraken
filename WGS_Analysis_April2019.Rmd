...
## Simulated Kraken data prep (NOT RUN; not using simulated data)

```{r simulated kraken data prep, eval = F}

# ===============================================
# !!! eval = F here---simulated data, not run !!!
# ===============================================
...
## merge *simulated* kraken data and metadata (NOT RUN; not using simulated data)

```{r merge kraken simulated data and metadata, eval = F}
...
## match *simulated* Kraken data to sample data

```{r match simulated kraken to sample data, eval = F}
