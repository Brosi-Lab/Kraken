...
#Re-analysis with kraken2 results
...
#Remove isolation negatives, undetermined, PCR negatives
kraken2_sub = kraken2_rbind[!(kraken2_rbind$mix.ID == "isol.n" | kraken2_rbind$mix.ID == "PCR.ne" | kraken2_rbind$mix.ID == "Undete"),]
